...
namespace EPassport.Controllers
{
    public class AppointmentDetailsController : Controller
    {
        ...
        {
            var ePassportContext = _context.AppointmentDetails.Include(a => a.Applicant);
        ...
        {
            ViewData["ApplicantId"] = new SelectList(_context.ApplicationDetails, "ApplicantId", "ApplicantId");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("MonthId,MonthName,AvailableDays,TimeSlots,ApplicantId")] AppointmentDetail appointmentDetail)
        {
            ...
            ViewData["ApplicantId"] = new SelectList(_context.ApplicationDetails, "ApplicantId", "ApplicantId", appointmentDetail.ApplicantId);
            return View(appointmentDetail);
        }
        ...
        {
            return _context.AppointmentDetails.Any(e => e.MonthId == id);
        }
    }
}
